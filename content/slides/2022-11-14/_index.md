...
cover_img: "postmodern-postmodern-is.jpg" # same dir as slideshow
...
# Postmodern/ity/ism: 
## Irony, Parody, and Pastiche<br />November 14, 2022
...
![Postmodern Memes](pomo-memes.png# w-90pct)
...
* Recognition of the above can invoke an affect of despair:<br />There is no "outside" of modernity? of late capitalism?
--
<br />or perhaps nihilism &rarr; ("f*ck it, let's party")
...
--- 
![Premodern vs Modern vs Postmodern](postmodernism-explained.png)
...
post-Fordist flexible accummulation (base)<br />&darr; &darr;<br />postmodernity (superstructure, or "cultural logic")

![Post-Fordism](fordist_post_fordist_production.png# w-8-12th)<br />Marxist economic determinism
...
| Modernity (or The Age of Enlightenment Empiricism and Humanism)| Postmodernity (or The Post Truth Era?)<div style="margin-right: 10vw">&nbsp;</div> |
| :----------- | :----------- |
...
* simulation / hyperreal<br /><br /><br /><br /><br />
...
![Church of Sant Francesc Convent](SantFrancescConvent.jpg# w-80pct)<br /><small><caption>[Church of Sant Francesc Convent](https://architizer.com/projects/church-of-sant-francesc-convent/) by David Closes Arquitecte, Santpedor, Spain</caption></small>

![Crystal Houses](CrystalHouses.jpg)<br /><small><caption>[Crystal Houses](https://architizer.com/projects/crystal-houses/) by MVRDV, Amsterdam, Netherlands</caption></small>

--
![Crystal Houses Detail](CrystalHouses2.jpg# absolute ofv l-50pct t-0 w-50pct)
...
![Always be sincere!](always-be-sincere.jpg)
