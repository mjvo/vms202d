...
# Marx on labor and alienation

In pre-capitalist modes of production (where craft production is the closest contemporary analog), people had a more authentic, life- and community-sustaining relationship to their work and what they produced.  However, under **industrial capitalism**:

* Workers are alienated from *the products of their labor* 
--
(quality not necessarily tied to their wages; product owned by company, not worker; no longer have knowledge of how to make a product, only one small component)
--

* Workers are alienated from *their labor itself* 
--
(they sell it as a commodity, for a wage; its life-sucking and meaningless rather than life-affirming; monotonous and disconnected rather than skilled and artful)
--

* Workers are alienated from themselves and each other, from their *species being.* 
--
(Ability to sustain oneself and community through meaningful creation is part of what it means to be human; capitalism reduces that activity to a wage transaction.  Work becomes merely a means for existence, a losing battle because the harder you work, the less value your work has.)

---
class: title, center

# Discuss:<br />"On the Phenomenon of Bullshit Jobs"
...
# Modernity
## Spectatorship, the Gaze, and Power, Part 1<br />September 21, 2022
...
* Identify a set of visual artefacts as candidates for the class' "2022 Visual Culture Time Capsule" [preparatory work for [Blog Post #1](https://sakai.duke.edu/access/content/group/VMS-202D-001-F22/Assignments/blog1_visual_time_capsule.pdf)]
